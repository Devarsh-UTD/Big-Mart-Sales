...
We cannot rank the variables based on the significane test conducted above beacuse the scale is different for different variables. We would need to standadize the variables in order to rank them. 
